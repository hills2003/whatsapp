...
//import {useAuth} from "../../../victorapp/src/Config/AuthProvider";
//import {storage} from "../../../victorapp/src/Config/Firebase";
...
function Contain(props) {
 const classes = useStyles();
    ...
    const content =[
        ...
        {avatar:blue,title:'dammy',subtitle:'what have u been up to ',badge:2,date:'10-2-20'},
        ...
        <div>
            <ThemeProvider theme={theme}>
                ...
                <Grid container spacing={5} item xs={12}>
                    ...
                    <Grid item xs={4} md={3} lg={1}><SearchIcon style={{color:'white'}}/> </Grid>
                    <Grid item xs={4} md={3} lg={1}><MenuIcon  style={{color:'white'}}/></Grid>
                </Grid>
